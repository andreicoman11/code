// BEGIN CUT HERE
// PROBLEM STATEMENT
// You are given long longs a, b, c and d. The numbers a and 
// b define an arithmetic progression that consists of all 
// numbers of the form a + b*x, where x is a nonnegative 
// integer. Likewise, c and d define a geometric progression 
// that consists of all the numbers that are equal to c * 
// d^y, where y is a nonnegative integer. You are also given 
// a long long upperBound. Return the total number of 
// integers between 1 and upperBound, inclusive, that belong 
// to the arithmetic progression, the geometric progression 
// or both.
// 
// DEFINITION
...
// long long
// Returns:long long
// Method signature:long long countThem(long long a, long 
// long b, long long c, long long d, long long upperBound)
// 
// 
// NOTES
// -The ^ operator in this statement denotes the 
// exponentiation operation. For example, 3^0 = 1 and 2^4 = 
// 2*2*2*2 = 16.
// 
// 
// CONSTRAINTS
// -a, b, c and upperBound will each be between 1 and 
// 1000000000000 (10^12), inclusive.
...
// Each positive integer is contained in at least one of the 
// progressions.
// 
// 1)
// 3
...
// inclusive, and there are 10 powers of 2, 512 being the 
// highest. As these two progressions do not have any common 
// elements, the total result is 343.
// 
// 2)
// 40
// 77
...
// Returns: 10
// 
// The 10 numbers are: 4, 20, 100, 452, 476, 500, 524, 548, 
// 572 and 596.
// 
// 4)
// 234
...
// END CUT HERE
	...
	public: long long countThem(long long a, long long b, long long c, long long d, long long up) {
      long long ans = 0;
      if( a<=up ) ans = (up - a)/b + 1;
